...
public class ExplicitWait {   // shuud garch irdgui buffering hiigeed loading hiigeed garch irdeg zuils
    ...
    public void elementToBeClickableTest(){
        driver.get("http://practice.cybertekschool.com/dynamic_loading/5"); // When you enter this page loads little longer
